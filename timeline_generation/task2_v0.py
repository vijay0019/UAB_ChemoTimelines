...
[
    ...
    ('docetaxol', 'contains-1', Date(year=2011, month=None, day_of_month=None, week_of_year=36)),
    ('cyclophosphamide', 'ends-on', Date(year=2011, month=10, day_of_month=10, week_of_year=None)),
...
class ChemoTimelineBuilder(dspy.Module):
    ...
    def process_timeline_update(self, current_timeline, new_events):
        ...
        return sorted(unique_events, key=lambda x: (x[2].year, x[2].month or 0, x[2].day_of_month or 0, x[2].week_of_year or 0, x[0], x[1]))  # Sort by date, then by drug and relation
...
if __name__ == "__main__":
    ...
    notes_path = "../../chemoTimelines2024_train_dev_labeled/subtask2/Patient_Notes"
